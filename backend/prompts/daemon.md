...
Write all files using the output format below.
...
Only output files that changed. If a file is unchanged, omit it entirely.

---
FILE: .emu/workspace/memory/YYYY-MM-DD.md
---
...
---
FILE: .emu/workspace/MEMORY.md
---
<facts about the user and their world. max 3,000 characters. newest/most relevant first.>

---
FILE: .emu/workspace/USER.md  ← only if explicitly changed
---
<updated content>

---
FILE: .emu/workspace/IDENTITY.md  ← only if explicitly changed
---
<updated content>